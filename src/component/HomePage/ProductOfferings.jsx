...
const ProductOfferings = () => {
  return (
    ...
    >
      <div className="container mx-auto text-center bg-third p-1 sm:p-2 md:p-2 lg:p-6 xl:p-8 rounded-lg shadow-lg">
        <h2 className="text-4xl font-bold mb-8 text-white">Our Services</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {products.map((product, index) => (
            <div
            key={index}
            className="relative p-4 rounded-lg shadow-lg transition-transform transform hover:scale-105 overflow-hidden group bg-white max-w-sm sm:max-w-md md:max-w-lg mx-auto" // Adjusted max-w for wider divs on mobile
          >
