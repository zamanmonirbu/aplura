...
const OfferFour = () => {
  ...
  useEffect(() => {
    // Ensure content is shown after component is mounted
    setInView(true); // Set inView to true once component is rendered
  }, []);
  ...
  const items = [
    ...
    },
    {
      ...
      image: image2,
      link: "/potato-exports", // Example link
    },
    {
  ...
  return (
    <div
      id="gallery"
      className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 p-4 pt-32 px-[12%] bg-green-700 transition-opacity duration-1000 ${
